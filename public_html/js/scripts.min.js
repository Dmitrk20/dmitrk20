/*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(t, e) {
    "use strict";
    ...
    function y(t, e, n) {
        var r, s, o = (n = n || i).createElement("script");
        if (o.text = t, e)
    ...
    _.fn = _.prototype = {
        ...
        for ("boolean" == typeof o && (c = o, o = arguments[a] || {}, a++), "object" == typeof o || g(o) || (o = {}), a === l && (o = this, a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t) i = t[e], "__proto__" !== e && o !== i && (c && i && (_.isPlainObject(i) || (r = Array.isArray(i))) ? (n = o[e], s = r && !Array.isArray(n) ? [] : r || _.isPlainObject(n) ? n : {}, r = !1, o[e] = _.extend(c, s, i)) : void 0 !== i && (o[e] = i));
        return o
    }, _.extend({
    ...
    var T = function(t) {
        var e, n, i, r, s, o, a, l, c, u, h, p, d, f, g, m, v, y, x, w = "sizzle" + 1 * new Date,
            _ = t.document,
            b = 0,
            C = 0,
            T = lt(),
        ...
        try {
            L.apply(S = z.call(_.childNodes), _.childNodes), S[_.childNodes.length].nodeType
        } catch (e) {
            L = {
            ...
            if (!r && ((e ? e.ownerDocument || e : _) !== d && p(e), e = e || d, g)) {
                if (11 !== b && (h = J.exec(t)))
                    if (s = h[1]) {
                        ...
                        } else if (y && (c = y.getElementById(s)) && x(e, c) && c.id === s) return i.push(c), i
                    } else {
                ...
                if (n.qsa && !$[t + " "] && (!m || !m.test(t)) && (1 !== b || "object" !== e.nodeName.toLowerCase())) {
                    if (v = t, y = e, 1 === b && U.test(t)) {
                        for ((u = e.getAttribute("id")) ? u = u.replace(it, rt) : e.setAttribute("id", u = w), a = (f = o(t)).length; a--;) f[a] = "#" + u + " " + xt(f[a]);
        ...
        for (e in n = at.support = {}, s = at.isXML = function(t) {
                ...
                return o !== d && 9 === o.nodeType && o.documentElement && (f = (d = o).documentElement, g = !s(d), _ !== d && (r = d.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", st, !1) : r.attachEvent && r.attachEvent("onunload", st)), n.attributes = ut((function(t) {
                    ...
                    e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && m.push("name" + O + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && m.push(":enabled", ":disabled"), f.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && m.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), m.push(",.*:")
                ...
                })), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), e = K.test(f.compareDocumentPosition), x = e || K.test(f.contains) ? function(t, e) {
                    ...
                    return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !n.sortDetached && e.compareDocumentPosition(t) === i ? t === d || t.ownerDocument === _ && x(_, t) ? -1 : e === d || e.ownerDocument === _ && x(_, e) ? 1 : u ? q(u, t) - q(u, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return h = !0, 0;
                    var n, i = 0,
                        r = t.parentNode,
                ...
                if ((t.ownerDocument || t) !== d && p(t), n.matchesSelector && g && !$[e + " "] && (!v || !v.test(e)) && (!m || !m.test(e))) try {
                    var i = y.call(t, e);
                        ...
                        return 1 === i && 0 === r ? function(t) {
                            ...
                            if (m) {
                                ...
                                if (f = [o ? m.firstChild : m.lastChild], o && y) {
                                    for (x = (d = (c = (u = (h = (p = m)[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] || [])[0] === b && c[1]) && c[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || f.pop();)
                                        if (1 === p.nodeType && ++x && p === e) {
                                            u[t] = [b, d, x];
                                            break
                                        }
                                } else if (y && (x = d = (c = (u = (h = (p = e)[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] || [])[0] === b && c[1]), !1 === x)
                                    for (;
                                        (p = ++d && p && p[g] || (x = d = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && ((u = (h = p[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] = [b, x]), p !== e)););
        ...
        function Ct(t, e, n, i, r, s) {
            return i && !i[w] && (i = Ct(i)), r && !r[w] && (r = Ct(r, s)), ct((function(s, o, a, l) {
                var c, u, h, p = [],
                    d = [],
                    f = o.length,
                    g = s || function(t, e, n) {
                    ...
                    v = n ? r || (s ? t : f || i) ? [] : o : m;
                if (n && n(m, v, a, l), i)
                    for (c = bt(v, d), i(c, [], a, l), u = c.length; u--;)(h = c[u]) && (v[d[u]] = !(m[d[u]] = h));
                if (s) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (u = v.length; u--;)(h = v[u]) && -1 < (c = r ? q(s, h) : p[u]) && (s[c] = !(o[c] = h))
                    }
            ...
            for (var e, n, r, s = t.length, o = i.relative[t[0].type], a = o || i.relative[" "], l = o ? 1 : 0, u = wt((function(t) {
                ...
                if (n = i.relative[t[l].type]) p = [wt(_t(p), n)];
                    ...
                    if ((n = i.filter[t[l].type].apply(null, t[l].matches))[w]) {
                        ...
                        return Ct(1 < l && _t(p), 1 < l && xt(t.slice(0, l - 1).concat({
                            value: " " === t[l - 2].type ? "*" : ""
        ...
        return yt.prototype = i.filters = i.pseudos, i.setFilters = new yt, o = at.tokenize = function(t, e) {
            ...
            if (!m) {
                ...
                (m = k(t, (r = f, a = 0 < (s = h).length, l = 0 < r.length, u = function(t, e, n, o, u) {
                    var h, f, m, v = 0,
                        y = "0",
                        x = t && [],
                        w = [],
                        ...
                        E = C.length;
                    for (u && (c = e === d || e || u); y !== E && null != (h = C[y]); y++) {
                        if (l && h) {
                    ...
                    if (v += y, a && y !== v) {
                        ...
                        if (t) {
                            if (0 < v)
                                for (; y--;) x[y] || w[y] || (w[y] = A.call(o));
                            w = bt(w)
                        }
                        L.apply(o, w), u && !t && 0 < w.length && 1 < v + s.length && at.uniqueSort(o)
                    }
                    return u && (b = T, c = _), x
                }, a ? ct(u) : u))).selector = t
            }
        ...
        }, n.sortStable = w.split("").sort(j).join("") === w, n.detectDuplicates = !!h, p(), n.sortDetached = ut((function(t) {
    ...
    _.filter = function(t, e, n) {
        ...
        is: function(t) {
            return !!S(this, "string" == typeof t && $.test(t) ? _(t) : t || [], !1).length
        }
    });
    var A, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (_.fn.init = function(t, e, n) {
        ...
        if (n = n || A, "string" == typeof t) {
            ...
            if (r[1]) {
                if (e = e instanceof _ ? e[0] : e, _.merge(this, _.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : i, !0)), D.test(r[1]) && _.isPlainObject(e))
    ...
    _.fn.extend({
        ...
        contents: function(t) {
            return void 0 !== t.contentDocument ? t.contentDocument : (j(t, "template") && (t = t.content || t), _.merge([], t.childNodes))
        }
    }, (function(t, e) {
        _.fn[t] = function(n, i) {
            var r = _.map(this, e, n);
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (r = _.filter(i, r)), 1 < this.length && (z[t] || _.uniqueSort(r), L.test(t) && r.reverse()), this.pushStack(r)
        }
    }));
    var H = /[^\x20\t\r\n\f]+/g;
    ...
    _.Callbacks = function(t) {
        ...
        var i, r, s, o, a = [],
            ...
            c = -1,
            u = function() {
                for (o = o || t.once, s = i = !0; l.length; c = -1)
                ...
                add: function() {
                    return a && (r && !i && (c = a.length - 1, l.push(r)), function e(n) {
                        _.each(n, (function(n, i) {
                            g(i) ? t.unique && h.has(i) || a.push(i) : i && i.length && "string" !== x(i) && e(i)
                        }))
                ...
                r = {
                    ...
                    then: function(e, i, r) {
                                ...
                                var a = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(e < s)) {
                                            ...
                                            c = t && ("object" == typeof t || "function" == typeof t) && t.then, g(c) ? r ? c.call(t, o(s, n, O, r), o(s, n, P, r)) : (s++, c.call(t, o(s, n, O, r), o(s, n, P, r), o(s, n, O, n.notifyWith))) : (i !== O && (a = void 0, l = [t]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = r ? c : function() {
                                        try {
                                            ...
                                            _.Deferred.exceptionHook && _.Deferred.exceptionHook(t, u.stackTrace), s <= e + 1 && (i !== P && (a = void 0, l = [t]), n.rejectWith(a, l))
                                        }
                                    };
                        ...
                        return _.Deferred((function(t) {
                            n[0][3].add(o(0, t, g(r) ? r : O, t.notifyWith)), n[1][3].add(o(0, t, g(e) ? e : O)), n[2][3].add(o(0, t, g(i) ? i : P))
                        })).promise()
                    },
                    promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (M(t, o.done(a(n)).resolve, o.reject, !e), "pending" === o.state() || g(r[n] && r[n].then))) return o.then();
    ...
    _.fn.ready = function(t) {
        ...
        readyWait: 1,
        ready: function(t) {
            (!0 === t ? --_.readyWait : _.isReady) || (_.isReady = !0) !== t && 0 < --_.readyWait || I.resolveWith(i, [_])
        }
    }), _.ready.then = I.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? t.setTimeout(_.ready) : (i.addEventListener("DOMContentLoaded", W), t.addEventListener("load", W));
    var B = function(t, e, n, i, r, s, o) {
            var a = 0,
                l = t.length,
                c = null == n;
            if ("object" === x(n))
                for (a in r = !0, n) B(t, e, a, n[a], !0, s, o);
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (r = Y.get(s), 1 === s.nodeType && !G.get(s, "hasDataAttrs"))) {
                    for (n = o.length; n--;) o[n] && 0 === (i = o[n].name).indexOf("data-") && (i = V(i.slice(5)), tt(s, i, r[i]));
            ...
            return "object" == typeof t ? this.each((function() {
                ...
                var n;
                if (s && void 0 === e) return void 0 !== (n = Y.get(s, t)) ? n : void 0 !== (n = tt(s, t)) ? n : void 0;
                this.each((function() {
                    Y.set(this, t, e)
                }))
    ...
    function ct(t, e, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; o--;) _.style(t, e, u + c), (1 - s) * (1 - (s = a() / l || .5)) <= 0 && (o = 0), u /= s;
    ...
    function ht(t, e) {
        for (var n, i, r, s, o, a, l, c = [], u = 0, h = t.length; u < h; u++)(i = t[u]).style && (n = i.style.display, e ? ("none" === n && (c[u] = G.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && at(i) && (c[u] = (l = o = s = void 0, o = (r = i).ownerDocument, a = r.nodeName, (l = ut[a]) || (s = o.body.appendChild(o.createElement(a)), l = _.css(s, "display"), s.parentNode.removeChild(s), "none" === l && (l = "block"), ut[a] = l)))) : "none" !== n && (c[u] = "none", G.set(i, "display", n)));
    ...
    function mt(t, e) {
        var n;
        return n = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && j(t, e) ? _.merge([t], n) : n
    }
    ...
    function _t(t, e, n, i, r) {
        for (var s, o, a, l, c, u, h = e.createDocumentFragment(), p = [], d = 0, f = t.length; d < f; d++)
            ...
            for (o = o || h.appendChild(e.createElement("div")), a = (dt.exec(s) || ["", ""])[1].toLowerCase(), l = gt[a] || gt._default, o.innerHTML = l[1] + _.htmlPrefilter(s) + l[2], u = l[0]; u--;) o = o.lastChild;
            _.merge(p, o.childNodes), (o = h.firstChild).textContent = ""
        } else p.push(e.createTextNode(s));
        for (h.textContent = "", d = 0; s = p[d++];)
            if (i && -1 < _.inArray(s, i)) r && r.push(s);
            else if (c = st(s), o = mt(h.appendChild(s), "script"), c && vt(o), n)
            for (u = 0; s = o[u++];) ft.test(s.type || "") && n.push(s);
        return h
    }
    ...
    function jt(t, e, n, i, r, s) {
        var o, a;
        if ("object" == typeof e) {
            for (a in "string" != typeof n && (i = i || n, n = void 0), e) jt(t, a, n, i, e[a], s);
            return t
        }
        ...
        n ? (G.set(t, e, !1), _.event.add(t, e, {
            ...
            handler: function(t) {
                ...
                if (1 & t.isTrigger && this[e]) {
                    ...
                    else if (o = s.call(arguments), G.set(this, e, o), i = n(this, e), this[e](), o !== (r = G.get(this, e)) || i ? G.set(this, e, !1) : r = {}, o !== r) return t.stopImmediatePropagation(), t.preventDefault(), r.value
    ...
    _.event = {
        ...
        add: function(t, e, n, i, r) {
            var s, o, a, l, c, u, h, p, d, f, g, m = G.get(t);
            if (m)
                for (n.handler && (n = (s = n).handler, r = s.selector), r && _.find.matchesSelector(rt, r), n.guid || (n.guid = _.guid++), (l = m.events) || (l = m.events = {}), (o = m.handle) || (o = m.handle = function(e) {
                        return void 0 !== _ && _.event.triggered !== e.type ? _.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(H) || [""]).length; c--;) d = g = (a = Tt.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), d && (h = _.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = _.event.special[d] || {}, u = _.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, s), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(t, i, f, o) || t.addEventListener && t.addEventListener(d, o)), h.add && (h.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), _.event.global[d] = !0)
        },
        remove: function(t, e, n, i, r) {
            var s, o, a, l, c, u, h, p, d, f, g, m = G.hasData(t) && G.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(H) || [""]).length; c--;)
                    if (d = g = (a = Tt.exec(e[c]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                        for (h = _.event.special[d] || {}, p = l[d = (i ? h.delegateType : h.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = p.length; s--;) u = p[s], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(s, 1), u.selector && p.delegateCount--, h.remove && h.remove.call(t, u));
                        o && !p.length && (h.teardown && !1 !== h.teardown.call(t, f, m.handle) || _.removeEvent(t, d, m.handle), delete l[d])
                    } else
                        for (d in l) _.event.remove(t, d + e[c], n, i, !0);
                _.isEmptyObject(l) && G.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, n, i, r, s, o, a = _.event.fix(t),
                l = new Array(arguments.length),
                c = (G.get(this, "events") || {})[a.type] || [],
                u = _.event.special[a.type] || {};
            for (l[0] = a, e = 1; e < arguments.length; e++) l[e] = arguments[e];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (o = _.event.handlers.call(this, a, c), e = 0;
                    (r = o[e++]) && !a.isPropagationStopped();)
                    for (a.currentTarget = r.elem, n = 0;
                        (s = r.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !1 !== s.namespace && !a.rnamespace.test(s.namespace) || (a.handleObj = s, a.data = s.data, void 0 !== (i = ((_.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        for (s = [], o = {}, n = 0; n < l; n++) void 0 === o[r = (i = e[n]).selector + " "] && (o[r] = i.needsContext ? -1 < _(r, this).index(c) : _.find(r, this, null, [c]).length), o[r] && s.push(i);
                        s.length && a.push({
                            elem: c,
                            handlers: s
                        })
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return pt.test(e.type) && e.click && j(e, "input") && Dt(e, "click", Et), !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return pt.test(e.type) && e.click && j(e, "input") && Dt(e, "click"), !0
                },
                _default: function(t) {
                    var e = t.target;
                    return pt.test(e.type) && e.click && j(e, "input") && G.get(e, "click") || j(e, "a")
                }
            },
            beforeunload: {
        ...
        which: function(t) {
            var e = t.button;
            return null == t.which && bt.test(t.type) ? null != t.charCode ? t.charCode : t.keyCode : !t.which && void 0 !== e && Ct.test(t.type) ? 1 & e ? 1 : 2 & e ? 3 : 4 & e ? 2 : 0 : t.which
        }
    ...
    function zt(t, e) {
        return j(t, "table") && j(11 !== e.nodeType ? e : e.firstChild, "tr") && _(t).children("tbody")[0] || t
    }
    ...
    function Ot(t, e) {
        var n, i, r, s, o, a, l, c;
        if (1 === e.nodeType) {
            if (G.hasData(t) && (s = G.access(t), o = G.set(e, s), c = s.events))
    ...
    function Pt(t, e, n, i) {
        ...
        var r, s, a, l, c, u, h = 0,
            ...
            m = e[0],
            v = g(m);
        if (v || 1 < p && "string" == typeof m && !f.checkClone && Nt.test(m)) return t.each((function(r) {
            var s = t.eq(r);
            v && (e[0] = m.call(this, r, s.html())), Pt(s, e, n, i)
        }));
        if (p && (s = (r = _t(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (l = (a = _.map(mt(r, "script"), qt)).length; h < p; h++) c = r, h !== d && (c = _.clone(c, !0, !0), l && _.merge(a, mt(c, "script"))), n.call(t[h], c, h);
            if (l)
                for (u = a[a.length - 1].ownerDocument, _.map(a, Ht), h = 0; h < l; h++) c = a[h], ft.test(c.type || "") && !G.access(c, "globalEval") && _.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && !c.noModule && _._evalUrl(c.src, {
                    nonce: c.nonce || c.getAttribute("nonce")
                }) : y(c.textContent.replace(Lt, ""), c, u))
        }
        return t
    }

    function Mt(t, e, n) {
        for (var i, r = e ? _.filter(e, t) : t, s = 0; null != (i = r[s]); s++) n || 1 !== i.nodeType || _.cleanData(mt(i)), i.parentNode && (n && st(i) && vt(mt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    _.extend({
        ...
        clone: function(t, e, n) {
            var i, r, s, o, a, l, c, u = t.cloneNode(!0),
                h = st(t);
            if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || _.isXMLDoc(t)))
                for (o = mt(u), i = 0, r = (s = mt(t)).length; i < r; i++) a = s[i], "input" === (c = (l = o[i]).nodeName.toLowerCase()) && pt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (s = s || mt(t), o = o || mt(u), i = 0, r = s.length; i < r; i++) Ot(s[i], o[i]);
                else Ot(t, u);
            return 0 < (o = mt(u, "script")).length && vt(o, !h && mt(t, "script")), u
        },
        ...
        _.fn[t] = function(t) {
            for (var n, i = [], r = _(t), s = r.length - 1, o = 0; o <= s; o++) n = o === s ? this : this.clone(!0), _(r[o])[e](n), a.apply(i, n.get());
    ...
    function Bt(t, e, n) {
        ...
        return (n = n || It(t)) && ("" !== (o = n.getPropertyValue(e) || n[e]) || st(t) || (o = _.style(t, e)), !f.pixelBoxStyles() && Rt.test(o) && Wt.test(e) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s)), void 0 !== o ? o + "" : o
    }
    ...
    function Ft(t, e) {
        ...
        function e() {
            if (u) {
                ...
                r = "1%" !== e.top, l = 12 === n(e.marginLeft), u.style.right = "60%", a = 36 === n(e.right), s = 36 === n(e.width), u.style.position = "absolute", o = 12 === n(u.offsetWidth / 3), rt.removeChild(c), u = null
            }
        }
    ...
    function Qt(t) {
        return _.cssProps[t] || Vt[t] || (t in Xt ? t : Vt[t] = function(t) {
    ...
    function te(t, e, n, i, r, s) {
        ...
        for (; o < 4; o += 2) "margin" === n && (l += _.css(t, n + it[o], !0, r)), i ? ("content" === n && (l -= _.css(t, "padding" + it[o], !0, r)), "margin" !== n && (l -= _.css(t, "border" + it[o] + "Width", !0, r))) : (l += _.css(t, "padding" + it[o], !0, r), "padding" !== n ? l += _.css(t, "border" + it[o] + "Width", !0, r) : a += _.css(t, "border" + it[o] + "Width", !0, r));
    ...
    function ee(t, e, n) {
        ...
        return (!f.boxSizingReliable() && r || "auto" === o || !parseFloat(o) && "inline" === _.css(t, "display", !1, i)) && t.getClientRects().length && (r = "border-box" === _.css(t, "boxSizing", !1, i), (s = a in t) && (o = t[a])), (o = parseFloat(o) || 0) + te(t, e, n || (r ? "border" : "content"), s, i, o) + "px"
    }
    ...
    _.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, o, a = V(e),
                    l = Gt.test(e),
                    c = t.style;
                if (l || (e = Qt(a)), o = _.cssHooks[e] || _.cssHooks[a], void 0 === n) return o && "get" in o && void 0 !== (r = o.get(t, !1, i)) ? r : c[e];
                "string" == (s = typeof n) && (r = nt.exec(n)) && r[1] && (n = ct(t, e, r), s = "number"), null != n && n == n && ("number" !== s || l || (n += r && r[3] || (_.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), o && "set" in o && void 0 === (n = o.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
            }
        },
        css: function(t, e, n, i) {
            var r, s, o, a = V(e);
            return Gt.test(e) || (e = Qt(a)), (o = _.cssHooks[e] || _.cssHooks[a]) && "get" in o && (r = o.get(t, !0, n)), void 0 === r && (r = Bt(t, e, i)), "normal" === r && e in Kt && (r = Kt[e]), "" === n || n ? (s = parseFloat(r), !0 === n || isFinite(s) ? s || 0 : r) : r
        }
    }), _.each(["height", "width"], (function(t, e) {
        _.cssHooks[e] = {
            get: function(t, n, i) {
                if (n) return !Zt.test(_.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ee(t, e, i) : lt(t, Yt, (function() {
                    return ee(t, e, i)
                }))
            },
            set: function(t, n, i) {
                var r, s = It(t),
                    ...
                    l = i ? te(t, e, i, a, s) : 0;
                return a && o && (l -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(s[e]) - te(t, e, "border", !1, s) - .5)), l && (r = nt.exec(n)) && "px" !== (r[3] || "px") && (t.style[e] = n, n = _.css(t, e)), Jt(0, n, l)
            }
        }
    })), _.cssHooks.marginLeft = Ft(f.reliableMarginLeft, (function(t, e) {
        if (e) return (parseFloat(Bt(t, "marginLeft")) || t.getBoundingClientRect().left - lt(t, {
            marginLeft: 0
        }, (function() {
        ...
        _.cssHooks[t + e] = {
            expand: function(n) {
                for (var i = 0, r = {}, s = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) r[t + it[i] + e] = s[i] || s[i - 2] || s[0];
                return r
            }
    ...
    var ie, re, se, oe, ae = /^(?:toggle|show|hide)$/,
        le = /queueHooks$/;
    ...
    function de(t, e, n) {
        var i, r, s = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var e = ie || ue(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), s = 0, o = c.tweens.length; s < o; s++) c.tweens[s].run(i);
        ...
        for (function(t, e) {
                var n, i, r, s, o;
                for (n in t)
                    if (r = e[i = V(n)], s = t[n], Array.isArray(s) && (r = s[1], s = t[n] = s[0]), n !== i && (t[i] = s, delete t[n]), (o = _.cssHooks[i]) && "expand" in o)
                        for (n in s = o.expand(s), delete t[i], s) n in t || (t[n] = s[n], e[n] = r);
                    else e[i] = r
            }(u, c.opts.specialEasing); s < o; s++)
            if (i = de.prefilters[s].call(c, t, u, c.opts)) return g(i.stop) && (_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return _.map(u, pe, c), g(c.opts.start) && c.opts.start.call(t, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), _.fx.timer(_.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    _.Animation = _.extend(de, {
        ...
        prefilters: [function(t, e, n) {
            ...
            if ((l = !_.isEmptyObject(e)) || !_.isEmptyObject(d))
                for (i in h && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = m && m.display) && (c = G.get(t, "display")), "none" === (u = _.css(t, "display")) && (c ? u = c : (ht([t], !0), c = t.style.display || c, u = _.css(t, "display"), ht([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === _.css(t, "float") && (l || (p.done((function() {
                        f.display = c
                    })), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always((function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    }))), l = !1, d) l || (m ? "hidden" in m && (g = m.hidden) : m = G.access(t, "fxshow", {
                    display: c
                }), s && (m.hidden = !g), g && ht([t], !0), p.done((function() {
                    for (i in g || ht([t]), G.remove(t, "fxshow"), d) _.style(t, i, d[i])
                }))), l = pe(g ? m[i] : 0, i, p), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
    ...
    }, se = i.createElement("input"), oe = i.createElement("select").appendChild(i.createElement("option")), se.type = "checkbox", f.checkOn = "" !== se.value, f.optSelected = oe.selected, (se = i.createElement("input")).value = "t", se.type = "radio", f.radioValue = "t" === se.value;
    ...
    _.fn.extend({
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== s && 8 !== s && 2 !== s) return void 0 === t.getAttribute ? _.prop(t, e, n) : (1 === s && _.isXMLDoc(t) || (r = _.attrHooks[e.toLowerCase()] || (_.expr.match.bool.test(e) ? fe : void 0)), void 0 !== n ? null === n ? void _.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : r && "get" in r && null !== (i = r.get(t, e)) ? i : null == (i = _.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
                    if (!f.radioValue && "radio" === e && j(t, "input")) {
                        var n = t.value;
    ...
    _.extend(_.event, {
        trigger: function(e, n, r, s) {
            ...
            if (a = f = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !be.test(y + _.event.triggered) && (-1 < y.indexOf(".") && (y = (x = y.split(".")).shift(), x.sort()), u = y.indexOf(":") < 0 && "on" + y, (e = e[_.expando] ? e : new _.Event(y, "object" == typeof e && e)).isTrigger = s ? 2 : 3, e.namespace = x.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : _.makeArray(n, [e]), d = _.event.special[y] || {}, s || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!s && !d.noBubble && !m(r)) {
                    for (c = d.delegateType || y, be.test(c + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), l = a;
                    l === (r.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || t)
                }
                for (o = 0;
                    (a = v[o++]) && !e.isPropagationStopped();) f = a, e.type = 1 < o ? c : d.bindType || y, (p = (G.get(a, "events") || {})[e.type] && G.get(a, "handle")) && p.apply(a, n), (p = u && a[u]) && p.apply && Q(a) && (e.result = p.apply(a, n), !1 === e.result && e.preventDefault());
                return e.type = y, s || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), n) || !Q(r) || u && g(r[y]) && !m(r) && ((l = r[u]) && (r[u] = null), _.event.triggered = y, e.isPropagationStopped() && f.addEventListener(y, Ce), r[y](), e.isPropagationStopped() && f.removeEventListener(y, Ce), _.event.triggered = void 0, l && (r[u] = l)), e.result
            }
        },
    ...
    function Ae(t, e, n, i) {
        ...
        if (Array.isArray(e)) _.each(e, (function(e, r) {
            n || $e.test(t) ? i(t, r) : Ae(t + "[" + ("object" == typeof r && null != r ? e : "") + "]", r, n, i)
        }));
    ...
    _.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var t = this.type;
                return this.name && !_(this).is(":disabled") && Se.test(this.nodeName) && !De.test(t) && (this.checked || !pt.test(t))
            })).map((function(t, e) {
                var n = _(this).val();
    ...
    Ie.href = Te.href, _.extend({
        ...
        ajax: function(e, n) {
            ...
            var r, s, o, a, l, c, u, h, p, d, f = _.ajaxSetup({}, n),
                g = f.context || f,
            ...
            if (v.promise(T), f.url = ((e || f.url || Te.href) + "").replace(Oe, Te.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(H) || [""], null == f.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = _.param(f.data, f.traditional)), Be(Pe, f, n, T), u) return T;
            for (p in (h = _.event && f.global) && 0 == _.active++ && _.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !He.test(f.type), s = f.url.replace(Le, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Ne, "+")) : (d = f.url.slice(s.length), f.data && (f.processData || "string" == typeof f.data) && (s += (ke.test(s) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (s = s.replace(ze, "$1"), d = (ke.test(s) ? "&" : "?") + "_=" + Ee++ + d), f.url = s + d), f.ifModified && (_.lastModified[s] && T.setRequestHeader("If-Modified-Since", _.lastModified[s]), _.etag[s] && T.setRequestHeader("If-None-Match", _.etag[s])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Re + "; q=0.01" : "") : f.accepts["*"]), f.headers) T.setRequestHeader(p, f.headers[p]);
            ...
            function E(e, n, i, a) {
                var c, p, d, w, b, C = n;
                u || (u = !0, l && t.clearTimeout(l), r = void 0, o = a || "", T.readyState = 0 < e ? 4 : 0, c = 200 <= e && e < 300 || 304 === e, i && (w = function(t, e, n) {
        ...
        wrapAll: function(t) {
            var e;
            return this[0] && (g(t) && (t = t.call(this[0])), e = _(t, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && e.insertBefore(this[0]), e.map((function() {
    ...
    f.cors = !!Xe && "withCredentials" in Xe, f.ajax = Xe = !!Xe, _.ajaxTransport((function(e) {
        var n, i;
        if (f.cors || Xe && !e.crossDomain) return {
            send: function(r, s) {
                var o, a = e.xhr();
                ...
                n = function(t) {
                    return function() {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Ue[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    _.ajaxSetup({
        ...
        var r, s, o, a = !1 !== e.jsonp && (Ze.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ze.test(e.data) && "data");
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = g(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ze, "$1" + r) : !1 !== e.jsonp && (e.url += (ke.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return o || _.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", s = t[r], t[r] = function() {
            o = arguments
        }, i.always((function() {
            void 0 === s ? _(t).removeProp(r) : t[r] = s, e[r] && (e.jsonpCallback = n.jsonpCallback, Qe.push(r)), o && g(s) && s(o[0]), o = s = void 0
        })), "script"
    })), f.createHTMLDocument = ((Ve = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ve.childNodes.length), _.parseHTML = function(t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (f.createHTMLDocument ? ((r = (e = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, e.head.appendChild(r)) : e = i), o = !n && [], (s = D.exec(t)) ? [e.createElement(s[1])] : (s = _t([t], e, o), o && o.length && _(o).remove(), _.merge([], s.childNodes)));
        var r, s, o
    }, _.fn.load = function(t, e, n) {
        var i, r, s, o = this,
            a = t.indexOf(" ");
        return -1 < a && (i = ye(t.slice(a)), t = t.slice(0, a)), g(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), 0 < o.length && _.ajax({
            url: t,
            type: r || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function(t, e, n) {
            var i, r, s, o, a, l, c = _.css(t, "position"),
                u = _(t),
                h = {};
            "static" === c && (t.style.position = "relative"), a = u.offset(), s = _.css(t, "top"), l = _.css(t, "left"), ("absolute" === c || "fixed" === c) && -1 < (s + l).indexOf("auto") ? (o = (i = u.position()).top, r = i.left) : (o = parseFloat(s) || 0, r = parseFloat(l) || 0), g(e) && (e = e.call(t, n, _.extend({}, a))), null != e.top && (h.top = e.top - a.top + o), null != e.left && (h.left = e.left - a.left + r), "using" in e ? e.using.call(t, h) : u.css(h)
        }
    }, _.fn.extend({
        offset: function(t) {
        ...
        _.each({
            ...
            _.fn[i] = function(r, s) {
                ...
                return B(this, (function(e, n, r) {
                    var s;
                    return m(e) ? 0 === i.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement, Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === r ? _.css(e, n, a) : _.style(e, n, r, a)
                }), e, o ? r : void 0, o)
            }
        }))
    ...
    }, _.isArray = Array.isArray, _.parseJSON = JSON.parse, _.nodeName = j, _.isFunction = g, _.isWindow = m, _.camelCase = V, _.type = x, _.now = Date.now, _.isNumeric = function(t) {
        var e = _.type(t);
    ...
    return _.noConflict = function(e) {
        return t.$ === _ && (t.$ = Ye), e && t.jQuery === _ && (t.jQuery = Ge), _
    }, e || (t.jQuery = t.$ = _), _
        ...
        if ("IntersectionObserver" in window) {
            let i = new IntersectionObserver((function(t, e) {
                t.forEach((function(t) {
                    if (t.isIntersecting) {
                        let e = t.target;
                        e.src = e.dataset.src, e.srcset = e.dataset.srcset, e.classList.remove("lazy"), i.unobserve(e)
                    }
                }))
            }));
            t.forEach((function(t) {
            ...
            let r = new IntersectionObserver((function(t, e) {
                t.forEach((function(t) {
                    t.isIntersecting && (t.target.classList.add("visible"), r.unobserve(t.target))
                }))
            }));
            ...
            let s = new IntersectionObserver((function(t, e) {
                t.forEach((function(t) {
                    if (t.isIntersecting) {
                        let e = t.target;
                        e.style.backgroundImage = "url(" + e.dataset.bg + ")", s.unobserve(e)
                    }
                }))
            }));
            ...
            t.src = t.dataset.src, t.srcset = t.dataset.srcset
        })), e.forEach((function(t) {
            ...
            mask: function(i, o) {
                ...
                return !i && this.length > 0 ? t(this[0]).data(t.mask.dataName)() : (o = t.extend({
                    ...
                    v.data(t.mask.dataName, (function() {
                        ...
                        var t;
                        clearTimeout(e), x = v.val(), t = m(), e = setTimeout((function() {
                        ...
                        8 === s || 46 === s || r && 127 === s ? (n = (e = v.caret()).begin, 0 == (i = e.end) - n && (n = 46 !== s ? function(t) {
                            for (; --t >= 0 && !l[t];);
                            return t
                        }(n) : i = p(n - 1), i = 46 === s ? p(i) : i), f(n, i), d(n, i - 1), t.preventDefault()) : 27 == s && (v.val(x), v.caret(0, m()), t.preventDefault())
...
//   });
  ...
  $('#project_1').click(function(){
    ...
    $('#project_1_1 .project-item-prev-img img').attr('src','img/keis/kvart/1/1.jpg')
     $('#project_1_2 .project-item-prev-img img').attr('src','img/keis/kvart/2/1.jpg')
     $('#project_1_3 .project-item-prev-img img').attr('src','img/keis/kvart/3/1.jpg')
     $('#project_1_4 .project-item-prev-img img').attr('src','img/keis/kvart/4/1.jpg')


     $('#project_1_1 .project-item-prev-text').html('Квартира <br>ЖК “Палацио”')
    $('#project_1_2 .project-item-prev-text').html('Квартира<br>Васильевского <br>острова линия')
    $('#project_1_3 .project-item-prev-text').html('Квартира ЖК  <br>«Дом на <br /> Фрунзенской»')
     $('#project_1_4 .project-item-prev-text').html('Квартира <br>в “Brilliant House”')


    $('#project_1_1 .project-item-prev-text').html('Квартира <br>ЖК “Палацио”')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Была поставлена задача: обеспечить качественное кондиционирование квартиры, спроектировать и смонтировать систему вентиляции для комфортного проживания.Для правильного размещения техники, перед началом условно разделили помещение на несколько зон. В квартире установили приточно-вытяжную систему вентиляции на базе Maico WS 470 KBET. Кондиционирование реализовали на базе мульти-сплит блоков от Daikin.')
    $('.project-item-text .city').html('ул.Ярцевская')
    $('.project-item-text .dogovor').html('Договор подписан 21.04.2017')
    $('.project-item-img').removeClass('project-show')
    $('.kvart_1_1').addClass('project-show')
    if ($('#project_1').hasClass('active')) {
    ...
    if ($('#project_1').hasClass('active')) {
       $('#project_1_2').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.kvart_1_2').addClass('project-show')
          $('#project_1_2 .project-item-prev-text').html('Квартира<br>Васильевского <br>острова линия')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Стояла задача создать комфортную температуру в квартире, возможность регулирования её параметров и установить надежную систему кондиционирования. Мы тщательно подобрали оборудование, использовали кондиционеры настенного типа DAIKIN. За каждую зону квартиры закрепили кондиционер с индивидуальным управлением.')
    $('.project-item-text .city').html('ул. Строителей, 3')
    $('.project-item-text .dogovor').html('Договор подписан 10.05.2018')
    $('.project-item-img').removeClass('project-show')
    $('.kvart_1_2').addClass('project-show')
       }); 
    }
    ...
    if ($('#project_1').hasClass('active')) {
       $('#project_1_3').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.kvart_1_3').addClass('project-show')
        $('#project_1_3 .project-item-prev-text').html('Квартира ЖК  <br>«Дом на <br /> Фрунзенской»')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Тип проекта: многоквартирный жилой дом площадью 12 000 кв. М.Выполнили проектирование стадии «Р» раздела «Сведения об инженерном оборудовании, о сетях обеспечения, перечень инженерно-технических мероприятий, содержание технологических решений». Примерная стоимость выполненных работ: 3 500 000 руб.')
    $('.project-item-text .city').html('Мосфильмовская ул., 8')
    $('.project-item-text .dogovor').html('Договор подписан 04.06.2019')
    $('.project-item-img').removeClass('project-show')
    $('.kvart_1_3').addClass('project-show')
       }); 
    }
    ...
    if ($('#project_1').hasClass('active')) {
       $('#project_1_4').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.kvart_1_4').addClass('project-show')
       $('#project_1_4 .project-item-prev-text').html('Квартира <br>в “Brilliant House”')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Спроектировали и смонтировали систему вентиляции и кондиционирования в квартире площадью 120 кв. м. Примерная стоимость выполненной работы составила 500 000 рублей.')
    $('.project-item-text .city').html('ул. Барклая 7К4')
    $('.project-item-text .dogovor').html('Договор подписан 11.10.2018')
    $('.project-item-img').removeClass('project-show')
    $('.kvart_1_4').addClass('project-show')
       }); 
    }
  ...
  $('#project_2').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-img img').attr('src','img/keis/dom/1/1.jpg')
     $('#project_1_2 .project-item-prev-img img').attr('src','img/keis/dom/2/1.jpg')
     $('#project_1_3 .project-item-prev-img img').attr('src','img/keis/dom/3/1.jpg')
     $('#project_1_4 .project-item-prev-img img').attr('src','img/keis/dom/4/1.jpg')


    $('#project_1_1 .project-item-prev-text').html('Частный дом, <br>улица Баушевская')
    $('#project_1_2 .project-item-prev-text').html('Коттедж <br>Фабричная улица')
    $('#project_1_3 .project-item-prev-text').html('Коттедж <br>р-н Курортный')
    $('#project_1_4 .project-item-prev-text').html('Дом <br>в дачном комплексе ')




    $('#project_1_1 .project-item-prev-text').html('Частный дом, <br>улица Баушевская')
    $('.project-item-text h1').html('Проект кондиционирования и вентиляции в готовом коттедже')
    $('.project-item-text span').html('Смонтировали бесшумную централизованную приточно-вытяжную вентиляционную систему с рекуперацией тепла, систему канального кондиционирования Daikin. Вентиляционная система практически бесшумна в работе (36 дБ); в доме установили две мульти-сплит системы кондиционирования канального и настенного типа Daikin.')
    $('.project-item-text .city').html('п. Мещерский')
    $('.project-item-text .dogovor').html('Договор подписан 09.04.2016')
    $('.project-item-img').removeClass('project-show')
    $('.dom_1_1').addClass('project-show')
    if ($('#project_2').hasClass('active')) {
       $('#project_1_1').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.dom_1_1').addClass('project-show')
        $('#project_1_1 .project-item-prev-text').html('Частный дом, <br>улица Баушевская')
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_2').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.dom_1_2').addClass('project-show')
        $('#project_1_2 .project-item-prev-text').html('Коттедж <br>Фабричная улица')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Установили систему вентиляции и кондиционирования. На проектирование ушло 2 недели, на согласование проекта с заказчиком еще 10 дней. Монтаж приточной установки (Колибри 1000 GTC), воздуховодов и адаптеров занял 25 дней. Также в этот срок входил монтаж наружного блока кондиционера. Затем монтаж 3-х внутренних блоков кондиционера и пуско-наладочные работы заняли 2 дня.  ')
        $('.project-item-text .city').html('Воскресенское поселение, д. Городище')
        $('.project-item-text .dogovor').html('Договор подписан 28.09.2019')
       }); 
    }
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_3').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.dom_1_3').addClass('project-show')
         $('#project_1_3 .project-item-prev-text').html('Коттедж <br>р-н Курортный')
        $('.project-item-text h1').html('Вентиляция и кондиционирование коттеджа')
        $('.project-item-text span').html('Провели монтаж приточно-вытяжной системы вентиляции и системы кондиционирования в коттедже на основе канальных кондиционеров и сплит-систем настенного типа. Установили кондиционеры канального и настенного типов MitsubishiElectric. На первом этапе использовали кондиционеры канального типа, а на втором - настенного.')
        $('.project-item-text .city').html('Краснопохорское поселение, д. Раево')
        $('.project-item-text .dogovor').html('Договор подписан 19.03.2016')
       }); 
    }
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_4').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.dom_1_4').addClass('project-show')
         $('#project_1_4 .project-item-prev-text').html('Дом <br>в дачном комплексе ')
        $('.project-item-text h1').html('Проект системы вентиляции загородного дома на основе ПВУ')
        $('.project-item-text span').html('Смонтирована система кондиционирования в загородном доме площадью 250 кв. М. Примерная стоимость работ составила 300 000 рублей. ')
        $('.project-item-text .city').html('Коттеджный поселок «Черничные поля».')
        $('.project-item-text .dogovor').html('Договор подписан 15.12.2017')
       }); 
    }
  ...
  $('#project_3').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-text').html('Коттедж, <br>р-н Приморский')
      $('#project_1_2 .project-item-prev-text').html('Коттедж, <br>р-н Курортрный, ')
    $('#project_1_3 .project-item-prev-text').html('Дом,<br> р-н Выборгский')
    $('#project_1_4 .project-item-prev-text').html('Коттедж<br>р-н Курортный')



          $('#project_1_1 .project-item-prev-img img').attr('src','img/keis/bas/1/1.jpg')
          $('#project_1_2 .project-item-prev-img img').attr('src','img/keis/bas/2/1.jpg')
          $('#project_1_3 .project-item-prev-img img').attr('src','img/keis/bas/3/1.jpg')
          $('#project_1_4 .project-item-prev-img img').attr('src','img/keis/bas/4/1.jpg')




        $('#project_1_1 .project-item-prev-text').html('Коттедж, <br>р-н Приморский')
        $('.project-item-text h1').html('Проектные и монтажные работы по системам вентиляции, кондиционирования и осушения воздуха')
        $('.project-item-text span').html('Выполнили весь комплекс работ - обследование объекта, проектирование, поставка оборудования и монтажные работы. Это один из бассейнов, где все работы проводились на этапе строительства, поэтому значительных трудностей не возникло. Также, благодаря этому, была возможность правильно проложить воздуховоды, установить необходимое оборудование и подключить всё к электросети и системе отопления.Площадь помещения бассейна: 58 м2. ')
        $('.project-item-text .city').html('Коттеджный поселок «Сетунька»')
        $('.project-item-text .dogovor').html('Договор подписан 22.02.2018')
        $('.project-item-img').removeClass('project-show')
        $('.bas_1_1').addClass('project-show')
        if ($('#project_3').hasClass('active')) {
       $('#project_1_1').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.bas_1_1').addClass('project-show')
        $('#project_1_1 .project-item-prev-text').html('Коттедж, <br>р-н Приморский')
       ...
       $('#project_1_2').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.bas_1_2').addClass('project-show')
        $('#project_1_2 .project-item-prev-text').html('Коттедж, <br>р-н Курортрный,')
        $('.project-item-text h1').html('Проектные и монтажные работы по системам вентиляции и осушения воздуха бассейна')
        $('.project-item-text span').html('Изначально планировалась установка настенного осушителя и системы вентиляции. Но, в итоге решили, что целесообразней увеличить мощность вентиляционной системы, вместо дорогостоящего осушителя. Тем самым, мы установили эффективную приточно-вытяжную систему вентиляцию бассейна, которая удаляет излишнюю влагу и обеспечивает бассейн свежим воздухом. Общая площадь помещения бассейна: 48 м2  ')
        $('.project-item-text .city').html('ул. Новослободская')
        $('.project-item-text .dogovor').html('Договор подписан 16.02.2018')
       }); 
    }
       ...
       $('#project_1_3').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.bas_1_3').addClass('project-show')
        $('#project_1_3 .project-item-prev-text').html('Дом,<br> р-н Выборгский')
        $('.project-item-text h1').html('Проектные и монтажные работы по системам вентиляции в бассейне')
        $('.project-item-text span').html('Спроектировали и смонтировали систему вентиляции и кондиционирования. Для организации качественного воздухообмена дома была предусмотрена приточно-вытяжная установка с рекуперацией тепла Maico. Для кондиционирования помещений использовали оборудование японского бренда Daikin. ')
        $('.project-item-text .city').html('ул. Маршала Тимошенко')
        $('.project-item-text .dogovor').html('Договор подписан 08.10.2016')
       }); 
    }
    ...
    if ($('#project_3').hasClass('active')) {
       $('#project_1_4').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.bas_1_4').addClass('project-show')
        $('#project_1_4 .project-item-prev-text').html('Коттедж<br>р-н Курортный')
        $('.project-item-text h1').html('Проектные и монтажные работы по системам вентиляции, кондиционирования')
        $('.project-item-text span').html('Стояла задача обеспечить оптимальный микроклимат бассейна в частном доме. Приняли решение комбинировать систему вентиляции и осушения воздуха. Вентиляция помещения бассейна организована с помощью одной приточно-вытяжной системы вентиляции. Общая площадь помещения бассейна: 95 м2.')
        $('.project-item-text .city').html('Сосенское поселение')
        $('.project-item-text .dogovor').html('Договор подписан 27.02.2019')
       }); 
    }
  ...
  $('#project_4').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-text').html(' “Дача Дурново”')
      $('#project_1_2 .project-item-prev-text').html('Кинотеатр<br>“Формула кино”')  
    $('#project_1_3 .project-item-prev-text').html(' Офис,<br>улица Бабушкина, 21')
    $('#project_1_4 .project-item-prev-text').html('Офисное здание')


          $('#project_1_1 .project-item-prev-img img').attr('src','img/keis/comers/1/1.jpg')
          $('#project_1_2 .project-item-prev-img img').attr('src','img/keis/comers/2/1.jpg')
          $('#project_1_3 .project-item-prev-img img').attr('src','img/keis/comers/3/1.jpg')
          $('#project_1_4 .project-item-prev-img img').attr('src','img/keis/comers/4/1.jpg')


    $('#project_1_1 .project-item-prev-text').html(' “Дача Дурново”')
        $('.project-item-text h1').html('Поставка и монтаж систем вентиляции и кондиционирования в офисное здание')
        $('.project-item-text span').html('Смонтировали систему общеобменной вентиляции и автоматизации, на основе базе оборудования VTS, VKT. Монтаж проводили в бизнес-центре площадью 2 381 кв. м. Примерная стоимость: 3 500 000 рублей.')
        $('.project-item-text .city').html('Набережная Тараса Шевченко, 3')
        $('.project-item-text .dogovor').html('Договор подписан 30.06.2016')
        $('.project-item-img').removeClass('project-show')
        $('.comers_1_1').addClass('project-show')
        if ($('#project_4').hasClass('active')) {
       $('#project_1_1').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.comers_1_1').addClass('project-show')
      $('#project_1_1 .project-item-prev-text').html(' “Дача Дурново”')
       ...
       $('#project_1_2').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.comers_1_2').addClass('project-show')
      $('#project_1_2 .project-item-prev-text').html('Кинотеатр<br>“Формула кино”')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Проведен монтаж систем вентиляции и кондиционирования в кинотеатре “Формула кино”. Площадь объекта: 1000 кв. м. Примерная стоимость работ составила 9 000 000 рублей. ')
        $('.project-item-text .city').html('м. Киевская')
        $('.project-item-text .dogovor').html('Договор подписан 01.05.2018')
       }); 
    }
     ...
     if ($('#project_4').hasClass('active')) {
       $('#project_1_3').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.comers_1_3').addClass('project-show')
      $('#project_1_3 .project-item-prev-text').html(' Офис,<br>улица Бабушкина, 21')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Перед нами стояла задача создать комфортные условия для работы сотрудников. Смонтировали кондиционеры канального типа MDV. Монтаж не отвлекал сотрудников офиса, так как проводили его в ночное время и выходные.')
        $('.project-item-text .city').html('м. ВДНХ')
        $('.project-item-text .dogovor').html('Договор подписан 10.08.2017')
       }); 
    }
     ...
     if ($('#project_4').hasClass('active')) {
       $('#project_1_4').click(function(){
        $('.project-item-img').removeClass('project-show')
        $('.comers_1_4').addClass('project-show')
      $('#project_1_4 .project-item-prev-text').html('Офисное здание')
        $('.project-item-text h1').html('Поставка и монтаж систем вентиляции в офисное помещение')
        $('.project-item-text span').html('Спроектирована и смонтирована система вентиляции. Выполнен комплекс работ: обследование объекта, проектирование, монтаж и пусконаладочные работы. Отличительной особенностью проекта является отсутствие технических помещений для установки оборудования, так как здание старое.')
        $('.project-item-text .city').html('Вятская улица, 70')
        $('.project-item-text .dogovor').html('Договор подписан 04.03.2017')
       }); 
    }
    ...
    $('#project_5').addClass('active')
     ...
     $('.active-prev').removeClass('active-prev')
        $('#project_1_1').addClass('active-prev')
         ...
         $('#project_1_1 .project-item-prev-text').html('Петергофское шоссе, <br> 74к6')
          $('#project_1_2 .project-item-prev-text').html('Помещение<br>под производство') 
        $('#project_1_3 .project-item-prev-text').html('улица Комсомола, 1')
         $('#project_1_4 .project-item-prev-text').html('Цех,<br> шоссе Революции, 88')



          $('#project_1_1 .project-item-prev-img img').attr('src','img/keis/promishl/1/1.jpg')
          $('#project_1_2 .project-item-prev-img img').attr('src','img/keis/promishl/2/1.jpg')
          $('#project_1_3 .project-item-prev-img img').attr('src','img/keis/promishl/3/2.jpg')
          $('#project_1_4 .project-item-prev-img img').attr('src','img/keis/promishl/4/1.jpg')


        $('#project_1_1 .project-item-prev-text').html('Петергофское шоссе, <br> 74к6')
            $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
            $('.project-item-text span').html('Необходимо было организовать необходимый расход воздуха в соответствии санитарных норм в помещениях завода. Было принято решение смонтировать установку с рекуперацией тепла. ')
            $('.project-item-text .city').html('ул. Щепкина, 40С1')
            $('.project-item-text .dogovor').html('Договор подписан 13.05.2018')
            $('.project-item-img').removeClass('project-show')
            $('.promishl_1_1').addClass('project-show')
            if ($('#project_5').hasClass('active')) {
           $('#project_1_1').click(function(){
            $('.project-item-img').removeClass('project-show')
            $('.promishl_1_1').addClass('project-show')
         $('#project_1_1 .project-item-prev-text').html('Петергофское шоссе, <br> 74к6')
         ...
         if ($('#project_5').hasClass('active')) {
           $('#project_1_2').click(function(){
            $('.project-item-img').removeClass('project-show')
            $('.promishl_1_2').addClass('project-show')
         $('#project_1_2 .project-item-prev-text').html('Помещение<br>под производство')
            $('.project-item-text h1').html('Поставка и монтаж систем вентиляции')
            $('.project-item-text span').html('Обеспечили вентиляцию и кондиционирование производственного помещения. Для вентиляции запроектировали 2 раздельные системы вентиляции: приточная и вытяжная. Кондиционирование помещений организовали сплит-системами. ')
            $('.project-item-text .city').html('ул. Салтыковская, 11Б')
            $('.project-item-text .dogovor').html('Договор подписан 10.12.2016')
           }); 
        }
         ...
         if ($('#project_5').hasClass('active')) {
           $('#project_1_3').click(function(){
            $('.project-item-img').removeClass('project-show')
            $('.promishl_1_3').addClass('project-show')
         $('#project_1_3 .project-item-prev-text').html('улица Комсомола, 1')
            $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
            $('.project-item-text span').html('Был разработан проект и подобрано оборудование для вытяжной вентиляции с защитой при пожаре для завода. Данная система включает несколько степеней управления в случае возникновения пожара.')
            $('.project-item-text .city').html('ул. Тимура Фрунзе, 11')
            $('.project-item-text .dogovor').html('Договор подписан 28.01.2019')
           }); 
        }
          ...
          if ($('#project_5').hasClass('active')) {
           $('#project_1_4').click(function(){
            $('.project-item-img').removeClass('project-show')
            $('.promishl_1_4').addClass('project-show')
         $('#project_1_4 .project-item-prev-text').html('Цех,<br> шоссе Революции, 88')
            $('.project-item-text h1').html('Перенос наружных блоков на объекте')
            $('.project-item-text span').html('Спроектирована и смонтирована приточно-вытяжная вентиляция цеха, которая автоматически поддерживает заданные параметры воздуха. Также в системах предусмотрено регулирование расхода воздуха.')
            $('.project-item-text .city').html('Магистральная улица.')
            $('.project-item-text .dogovor').html('Договор подписан 03.07.2018')
           }); 
        }
...
$('.top-nav a[href*="#"]').click(function() {
    var plus = $(window).innerHeight() / 100 - 65;
        $page.animate({
...
$("form.formSend").submit(function() { //Change
    var th = $(this);
    $.ajax({
        type: "POST",
        url: "mail.php", //Change
        ...
        $('.overlay-thx').css('display','block')
    });
    return false;
});
$("form.calc").submit(function() { //Change
    var th = $(this);
    $.ajax({
        type: "POST",
        url: "calc.php", //Change
