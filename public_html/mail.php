...
$mail->addAddress('vsg-msk@yandex.ru');     // Кому будет уходить письмо
...
$mail->Subject = 'Заявка с сайта VSG';
...
$roistatData = array(
    ...
    'roistat' => isset($_COOKIE['roistat_visit']) ? $_COOKIE['roistat_visit'] : null,
	    'comment' => 'utm_source: {utmSource}, utm_medium: {utmMedium}, utm_campaign: {utmCampaign}, utm_term: {utmTerm}','<br>', 
