...
$mail->Body    = 'Полный url вход : nissan.ru/?utm_source=google&utm_campign=bestOrder' . '<br>Марка: Nissam ' . '<br>Модель: PATROL ' . '<br>Комплектация: SE+ ' . '<br>ФИО: ' .$name . ' <br> Телефон: ' .$phone;
$mail->AltBody = '';
